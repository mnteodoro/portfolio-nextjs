...
const Projects = () => {
  ...
  return (
    <div id="projects" className='w-full h-full p-2'>
        ...
        <div data-aos='flip-down' data-aos-duration='400' data-aos-offset='400' ><ProjectItem title='Feast Deli' backgroundImg={propertyImg} projectUrl='property'/></div>
        ...
        <div data-aos='flip-down' data-aos-duration='400' data-aos-offset='400' ><ProjectItem title='Apple Redesigned' backgroundImg={twitchImg} projectUrl='twitch'/></div>
