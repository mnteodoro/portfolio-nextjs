    ...
    return (
        <div id="home" className='w-full h-screen text-center bg-[#131628]'>
            <div data-aos='fade-left' data-aos-duration='700' className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
                ...
                <a href='https://drive.google.com/drive/folders/14lzxyWCM-RLFbfWsa5sg3a-QCovVoG_y?usp=share_link'><p className='rounded-xl bg-[#5651e5] px-4 pt-2 pb-2 text-gray-900 hover:text-[#5651e5] hover:bg-gray-800 duration-500'>Download CV</p></a>
                </div>
