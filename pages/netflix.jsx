    ...
    return (
        <div className='w-full'>
            <div className='w-screen h-[30vh] lg:h-[40vh] relative'>
                ...
                <Image className='absolute z-1' layout='fill' objectFit='cover' alt='/' src={netflixImg}></Image>
                <div className='absolute top-[70%] right-[50%] left-[50%] w-full max-w-[1240px] translate-x-[-50%] translate-y-[-50%] p-4 z-10 text-white'>
                    <h2 data-aos='fade-left' data-aos-duration='500' className='py-2 text-red-600'>
                        Netflix Website Clone
                    </h2>
                    <h3 data-aos='fade-right' data-aos-duration='500'>React | Tailwind | Firebase</h3>
                    <div data-aos='fade-right' data-aos-duration='500' className='flex pt-6 gap-5'> 
        ...
        <div className="col-span-4">
            <p data-aos='fade-right' data-aos-duration='500' className="text-white">Project</p>
            <h2 data-aos='fade-right' data-aos-duration='500' className='pb-5 pt-2 text-gray-400'>Overview</h2>
            <p data-aos='fade-right' data-aos-duration='500' className="text-gray-100 pb-5">
        ...
        <button data-aos='flip-up' className='px-8 py-2 mt-4 mr-8 font-semibold hover:scale-105 duration-300'>Website</button>
        <button data-aos='flip-up' className='px-8 py-2 mt-4 font-semibold text-gray-800 hover:scale-105 duration-300'>Code</button>
        </div>
        <div data-aos='fade-left' data-aos-duration='500' className='col-span-4 md:col-span-1 rounded-xl shadow-xl shadow-gray-800'>
            <div className='p-2'>
